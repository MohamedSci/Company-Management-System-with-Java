   ...
   GridBagConstraints g1 = new GridBagConstraints();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        aa.setVisible(false);
         ue.setVisible(false);
          ae.setVisible(true);
          exec(AllEmployees.allEmployeestable ,"select employee.employee_id , employee.first_name , employee.last_name , employee.salary , "
                + "department.department_name , employee.manager_id , employee.hire_date,employee.gender,employee.email "
                + "from employee   \n"
                + "join department  \n"
